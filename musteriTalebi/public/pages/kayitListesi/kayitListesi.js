    ...
    .then(data => {
      ...
      const addDataToTable = (filteredData) => {
        ...
        filteredData.forEach(item => {
          ...
          <td class="text-center"><span class="w-50 badge ${badgeDegeri}">${badgeSinifi}</span></td>
            <td class="text-center flex w-100 justify-content-center gap-12">
              
              <button onclick="sil('${item.e_musteri_numarasi}')" class="bin-button w-50">
              ...
              <button class="Btn w-50" onclick="acModal('${item.e_musteri_numarasi}')">
                <span>Düzenle</span>
